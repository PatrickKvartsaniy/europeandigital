...
@section('content')
                        ...
                        <div class="content-body">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <table id="members-admin" class="display table table-hover table-condensed"
                                           cellspacing="0"
                                           width="100%">
                                        <thead>
                                        <tr>
    ...
    @push('scripts')
        ...
        <script>
            ...
            var oTableActivity = $('#members-admin').DataTable({
                processing: true,
                serverSide: true,
                dom: 'rtip',
                ajax: {
                    url: '{!! route('datatables.get_members_list_admin') !!}',
                    method: 'GET',
                    data: function (d) {
            ...
            function delete_member(_this) {
                ...
                $.ajax({
                    method: "POST",
                    url: '{{urlloc('/admin/members/delete')}}',
                    dataType: 'json',
                    data: data
                }).done(function (data) {
                    location.reload();
