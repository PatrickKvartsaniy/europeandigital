                        ...
                        <div class="content-body">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <table id="users-admin" class="display table table-hover table-condensed"
                                           cellspacing="0"
                                           width="100%">
                                        <thead>
                                        <tr>
...
{{--                                            <th>Facebook</th>--}}
    ...
    @push('scripts')
        ...
        <script>
            ...
            var oTableActivity = $('#users-admin').DataTable({
                processing: true,
                serverSide: true,
                dom: 'rtip',
                ajax: {
                    url: '{!! route('datatables.get_users_list_admin') !!}',
                    method: 'GET',
                    data: function (d) {
                ...
                columns: [
                    ...
                    {data: 'position_number', name: 'position_number'},
